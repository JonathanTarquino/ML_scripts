...
########## "windows": list of window sizes to apply windowed analysis - max 11
...
def main3Dfeature(input_image_path,input_mask_path,output_path,ax_cor_sag = 'ax',windows=[3,5,7,11],save_features=True):
    if '.mha' in input_image_path:
        ...
        features = extract3DFeatureInfo(volumeIm,maskVol_array,ws_options = windows, with_stats=False, class_options = ['raw','gray','gradient','gabor','laws','collage'])
